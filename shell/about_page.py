...
class AboutPage(ScrollPage):
    def __init__(self) -> None:
        ...
        layout.addWidget(label("Office Tools", "cardTitle"))
        layout.addWidget(label(f"Padroniza + Checklist  ·  Versão {__version__}", "muted"))
        layout.addWidget(label(
            "Este pacote inclui o painel inicial, a navegação e as preferências. "
            "Padroniza e Checklist têm áreas reservadas para conectar os aplicativos existentes.", "body", True))
