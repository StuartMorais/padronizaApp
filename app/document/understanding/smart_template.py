...
from app.domain.validation import validation_hint
from app.document.understanding.layout import (
...
from app.document.docx.controls import normalize_control_id
...
def _field_id_from_token(raw: str) -> str:
    definition = parse_tag(str(raw), strict=False)
    return normalize_control_id(definition.field_id)
