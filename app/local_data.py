...
class LocalDataStore:
    ...
    def __init__(self, data_dir: Path) -> None:
        ...
        self._profiles = JsonFileStore(self.data_dir / "profiles.json", [])
        self._recent = JsonFileStore(self.data_dir / "recent_documents.json", [])
        self._drafts = JsonFileStore(self.data_dir / "drafts.json", {})
        self._audit = JsonFileStore(self.data_dir / "audit_history.json", [])
        self._sequences = JsonFileStore(self.data_dir / "sequences.json", {})
