        ...
        try:
            ...
            try:
                ...
                show_exception_dialog(
                    ...
                    'A cópia do modelo não pôde ser criada.',
                    retry_exc,
                    stage='template_manager.duplicate',
        ...
        while True:
            try:
                ...
                show_exception_dialog(
                    ...
                    'O pacote de modelo não pôde ser importado.',
                    exc,
                    stage='template_manager.import',
    ...
    def _export_selected(self) -> None:
        ...
        try:
            ...
            show_exception_dialog(
                ...
                'O pacote do modelo não pôde ser exportado.',
                exc,
                stage='template_manager.export',
                context={"template_id": template_id, "destination": filename},
            )
            return
        show_toast(
            self,
    ...
    def _diagnose_selected(self) -> None:
        ...
        try:
            ...
            show_exception_dialog(
                ...
                exc,
                stage='template_manager.diagnostics',
                context={"template_id": template_id},
            )
            return
        DiagnosticsDialog(
    ...
    def _archive_selected(self) -> None:
        ...
        try:
            ...
            show_exception_dialog(
                ...
                'O modelo não pôde ser arquivado.',
                exc,
                stage='template_manager.archive',
                context={"template_id": template_id},
            )
            return
    ...
    def _delete_selected(self) -> None:
        ...
        try:
            ...
            show_exception_dialog(
                ...
                'O modelo não pôde ser excluído.',
                exc,
                stage='template_manager.delete',
                context={"template_id": template_id},
            )
            return
        self._reload()
