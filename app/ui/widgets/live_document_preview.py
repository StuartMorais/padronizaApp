...
class LiveDocumentPreview(QFrame):
    ...
    def refresh_now(self) -> None:
        ...
        capabilities = DEFAULT_CONVERTER.capabilities()
        if not capabilities.docx_to_pdf:
            self._show_error(
                "Nenhum conversor DOCX → PDF está disponível para gerar a prévia."
            )
            return
